...
export class AuthService extends IonicAuth {
  ...
  private async addConfig() {
    ...
    const redirectUri = this.onDevice() ? 'com.okta.dev-388922:/callback' : 'http://localhost:8100/implicit/callback';
    const logoutRedirectUri = this.onDevice() ? 'com.okta.dev-388922:/logout' : 'http://localhost:8100/implicit/logout';
    const clientId = '0oa1b7v4c4Mvk9V4i357';
    const issuer = 'https://dev-388922.okta.com/oauth2/default';
